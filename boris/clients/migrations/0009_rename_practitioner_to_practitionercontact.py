...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('clients_practitioner_users', 'practitioner_id', 'practitionercontact_id')
        db.rename_table('clients_practitioner', 'clients_practitionercontact')
        db.rename_table('clients_practitioner_users', 'clients_practitionercontact_users')

    def backwards(self, orm):
        db.rename_column('clients_practitionercontact_users', 'practitionercontact_id', 'practitioner_id')
        db.rename_table('clients_practitionercontact', 'clients_practitioner')
        db.rename_table('clients_practitionercontact_users', 'clients_practitioner_users')
