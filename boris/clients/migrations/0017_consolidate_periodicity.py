...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        orm.RiskyManners.objects.filter(periodicity_in_present=4).update(periodicity_in_present=2)
        orm.RiskyManners.objects.filter(periodicity_in_present=5).update(periodicity_in_present=3)
        orm.RiskyManners.objects.filter(periodicity_in_present=6).update(periodicity_in_present=4)
        orm.RiskyManners.objects.filter(periodicity_in_past=6).update(periodicity_in_past=4)
