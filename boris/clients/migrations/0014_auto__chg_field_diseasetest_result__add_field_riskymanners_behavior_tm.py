...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DiseaseTest.result'
        db.alter_column('clients_diseasetest', 'result', self.gf('django.db.models.fields.SmallIntegerField')())
        # Adding field 'RiskyManners.behavior_tmp'
        db.add_column('clients_riskymanners', 'behavior_tmp',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'DiseaseTest.result'
        db.alter_column('clients_diseasetest', 'result', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
        # Deleting field 'RiskyManners.behavior_tmp'
        db.delete_column('clients_riskymanners', 'behavior_tmp')
