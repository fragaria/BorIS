...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RiskyManners.periodicity_in_past'
        db.add_column('clients_riskymanners', 'periodicity_in_past',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'RiskyManners.periodicity_in_present'
        db.add_column('clients_riskymanners', 'periodicity_in_present',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RiskyManners.periodicity_in_past'
        db.delete_column('clients_riskymanners', 'periodicity_in_past')

        # Deleting field 'RiskyManners.periodicity_in_present'
        db.delete_column('clients_riskymanners', 'periodicity_in_present')
