# -*- coding: utf-8 -*-
"""Step 1/3 of the practitioner migration - add new columns."""
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Practitioner.id'
        db.add_column('clients_practitioner', 'id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Practitioner.person_or_institution'
        db.add_column('clients_practitioner', 'person_or_institution',
                      self.gf('django.db.models.fields.CharField')(null=True, max_length=255),
                      keep_default=False)

        # Adding field 'Practitioner.date'
        db.add_column('clients_practitioner', 'date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding M2M table for field users on 'Practitioner'
        db.create_table('clients_practitioner_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('practitioner', models.ForeignKey(orm['clients.practitioner'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('clients_practitioner_users', ['practitioner_id', 'user_id'])


        # Changing field 'Practitioner.note'
        db.alter_column('clients_practitioner', 'note', self.gf('django.db.models.fields.TextField')(default=''))
