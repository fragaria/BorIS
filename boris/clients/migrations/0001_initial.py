...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('clients_client', (
            ...
            ('primary_drug', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Drug'])),
            ('application', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True, blank=True)),
        ))
    ...
    models = {
        ...
        'clients.client': {
            ...
            'application': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
