...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Client.primary_drug' to match new field type.
        db.rename_column('clients_client', 'primary_drug_id', 'primary_drug')
        # Changing field 'Client.primary_drug'
        db.alter_column('clients_client', 'primary_drug', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
        # Removing index on 'Client', fields ['primary_drug']
        db.delete_index('clients_client', ['primary_drug_id'])


        # Renaming column for 'DrugUsage.drug' to match new field type.
        db.rename_column('clients_drugusage', 'drug_id', 'drug')
        # Changing field 'DrugUsage.drug'
        db.alter_column('clients_drugusage', 'drug', self.gf('django.db.models.fields.PositiveSmallIntegerField')())
        # Removing index on 'DrugUsage', fields ['drug']
        db.delete_index('clients_drugusage', ['drug_id'])


    def backwards(self, orm):
        # Adding index on 'DrugUsage', fields ['drug']
        db.create_index('clients_drugusage', ['drug_id'])

        # Adding index on 'Client', fields ['primary_drug']
        db.create_index('clients_client', ['primary_drug_id'])
        ...
        # Renaming column for 'Client.primary_drug' to match new field type.
        db.rename_column('clients_client', 'primary_drug', 'primary_drug_id')
        # Changing field 'Client.primary_drug'
        db.alter_column('clients_client', 'primary_drug_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Drug'], null=True))

        # Renaming column for 'DrugUsage.drug' to match new field type.
        db.rename_column('clients_drugusage', 'drug', 'drug_id')
        # Changing field 'DrugUsage.drug'
        db.alter_column('clients_drugusage', 'drug_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['clients.Drug']))
    ...
    models = {
        ...
        'clients.anamnesis': {
            ...
            'education': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '7'}),
            'employment': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '8'}),
        ...
        'clients.client': {
            ...
            'person_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['clients.Person']", 'unique': 'True', 'primary_key': 'True'}),
            'primary_drug': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'clients.drugusage': {
            ...
            'drug': ('django.db.models.fields.PositiveSmallIntegerField', [], {}),
