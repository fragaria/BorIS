...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HarmReduction.svip_person_count'
        db.add_column('services_harmreduction', 'svip_person_count',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'HarmReduction.svip_person_count'
        db.delete_column('services_harmreduction', 'svip_person_count')
    ...
    models = {
        ...
        'services.harmreduction': {
            ...
            'svip_person_count': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'})
        },
