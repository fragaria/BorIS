# -*- coding: utf-8 -*-
"""Phone counselling refactor - 1/3."""
import datetime
...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Encounter.is_by_phone'
        db.add_column('services_encounter', 'is_by_phone',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Encounter.is_by_phone'
        db.delete_column('services_encounter', 'is_by_phone')
