...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HarmReduction.svip'
        db.delete_column('services_harmreduction', 'svip')


        # Changing field 'AsistService.where'
        db.alter_column('services_asistservice', 'where', self.gf('fragapy.fields.models.MultiSelectField')(max_length=10))
    def backwards(self, orm):
        # Adding field 'HarmReduction.svip'
        db.add_column('services_harmreduction', 'svip',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'AsistService.where'
        db.alter_column('services_asistservice', 'where', self.gf('django.db.models.fields.CharField')(max_length=1))
    models = {
        'auth.group': {
