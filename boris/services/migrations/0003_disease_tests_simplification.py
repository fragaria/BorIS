...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DiseaseTest.post_test_advice'
        db.delete_column('services_diseasetest', 'post_test_advice')

        # Deleting field 'DiseaseTest.test_execution'
        db.delete_column('services_diseasetest', 'test_execution')

        # Deleting field 'DiseaseTest.pre_test_advice'
        db.delete_column('services_diseasetest', 'pre_test_advice')


        # Changing field 'DiseaseTest.disease'
        db.alter_column('services_diseasetest', 'disease', self.gf('django.db.models.fields.PositiveSmallIntegerField')())

        # Changing field 'DiseaseTest.sign'
        db.alter_column('services_diseasetest', 'sign', self.gf('django.db.models.fields.CharField')(max_length=1))

    def backwards(self, orm):
        # Adding field 'DiseaseTest.post_test_advice'
        db.add_column('services_diseasetest', 'post_test_advice',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DiseaseTest.test_execution'
        db.add_column('services_diseasetest', 'test_execution',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DiseaseTest.pre_test_advice'
        db.add_column('services_diseasetest', 'pre_test_advice',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'DiseaseTest.disease'
        db.alter_column('services_diseasetest', 'disease', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

        # Changing field 'DiseaseTest.sign'
        db.alter_column('services_diseasetest', 'sign', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    models = {
        ...
        'services.diseasetest': {
            ...
            'disease': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'service_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['services.Service']", 'unique': 'True', 'primary_key': 'True'}),
