...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting the contenttype was a mistake - it is needed in the
        # Service.real_content_type method.
        orm['contenttypes.ContentType'].objects.create(app_label='services', model='phoneusage', name=u'Použití telefonu klientem')
